...
1. Purely Computational: *both* analysis and visualisation are accomplished via code
2. Mostly Computational: *only* the analysis is accomplished via code, visualisation is via a GIS.
...
Clone and reproduce: [github.com/alasdairrae/wpc](https://github.com/alasdairrae/wpc) and explanation: [statsmapsnpix.com/2019/08/constituency-cards.html](http://www.statsmapsnpix.com/2019/08/constituency-cards.html).
...
[Building footprints](https://github.com/Microsoft/USBuildingFootprints/) collected by Microsoft, but presentation by New York Times [traces lasting physical effects](https://www.nytimes.com/interactive/2018/10/12/us/map-of-every-building-in-the-united-states.html).
...
Humans can only take in so much data at once. Your choice of colour scheme can profoundly affect how people see the world.
