...
Regular Expressions are to Text.
...
| Date                                    | Credit cards                              |
| Sentence structure                      | Syntax highlighting                       |
...
| `' '`, `\n`, `\t`, `\r`, `\f`, `\v`                          | `\s`                                                         | `\S`           |
| `.`, `[`, `]`, `+`, `$`, `^`, `|`, `{`, `}`, `*`, `(`, `)`, `?` | Character must be preceded by a `\` *unless* enclosed in a `[...]` (*e.g.* `[a-z0-9$]`). | None           |
